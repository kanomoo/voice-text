...
> 
> ⚠️ **ปรัชญาและหน้าที่หลักของ AI (Core Mission):**  
> **"ไม่มีใครมานั่งเปิดฟังไฟล์เสียง หน้าที่ของ AI คือการแปลงไฟล์เสียงทุกไฟล์ให้เป็นข้อความ (Text) ทั้งไฟล์ `.txt` ถอดความคำต่อคำ 100% (Verbatim) และไฟล์ `.md` สรุปวิเคราะห์เชิงลึก จากนั้นนำเนื้อหาข้อความทั้งหมด (ทฤษฎี, ตาราง, ข้อสอบ, เฉลย, โค้ด, เวิร์กช็อป) ไปใส่ไว้ใน Wiki หรือ Web ของแต่ละโปรเจกต์ที่เกี่ยวข้องทันที!"**
