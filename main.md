...
flowchart TD
    ...
    F --> H1["5. สร้างไฟล์ .txt ถอดคำพูดทุกคำพูด (Verbatim 100%)"]
    G --> H1
    H1 --> H2["6. สร้างไฟล์ Transcript_*.md วิเคราะห์สาระ/ข้อสอบ/เดดไลน์"]
    H2 --> I["7. อัปเดต README.md ของวิชานั้น และ 00_MASTER_INDEX.md"]
...
**กฎเหล็ก:** ต้องสร้างไฟล์ `.txt` ที่มีชื่อเดียวกับไฟล์เสียง (เช่น `20260902_112628.txt`) บันทึกคำพูดคำต่อคำ (Verbatim 100%) ห้ามตัดทอน ห้ามสรุปย่อ และห้ามตกหล่น เพื่อเก็บหลักฐานคำพูดจริงของผู้บรรยายอย่างสมบูรณ์แบบ (อ้างอิงมาตรฐานเดียวกับ `dsa20260909_092303.txt`)
...
### ขั้นตอนที่ 8: ย้ายไฟล์เสียงที่เสร็จแล้วเข้าโฟลเดอร์ `Success/` (Archive Completed Audio)
